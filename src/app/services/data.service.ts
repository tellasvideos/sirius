...
export class DataService {
  ...
  // development  http://strongboxao.ddns.net:8022/
  ...
  getCompanyName(){
    return this.http.get('http://strongboxao.ddns.net:8022/api/v1/empresas/');
  }

  // Method to get Category
  getCategory(){
    return this.http.get('http://strongboxao.ddns.net:8022/api/v1/categorias/');
  }

  // Method to get village
  getMunicipio(){
    return this.http.get('http://strongboxao.ddns.net:8022/api/v1/municipios/');
  }
