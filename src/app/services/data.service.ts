...
export class DataService {
  ...
  get_Provinces_url = 'http://localhost:8001/api/v1/provinces/';

  //url to proposal agreeement
  get_Proposal_Agreement_url = 'http://localhost:8001/api/v1/proposeragreements/';
  delete_Proposal_Agreement_url = 'http://localhost:8001/api/v1/proposeragreements/';
  save_Proposal_Agreement_url = 'http://localhost:8001/api/v1';

  // url to get inquiriers
  get_inquiriers_url = 'http://localhost:8001/api/v1/inquirers/';
  save_inquiriers_url = 'http://localhost:8001/api/v1';
  delete_inquiriers_url = 'http://localhost:8001/api/v1/inquirers/';

  // Value chain to interest expression
  delete_ValueChainsToInterestExpress_url = 'http://localhost:8001/api/v1/valuechaintointerestexpressions/';
  get_ValueChainsToInterestExpress_url = 'http://localhost:8001/api/v1/valuechaintointerestexpressions/';
  save_ValueChainsToInterestExpress_url = 'http://localhost:8001/api/v1'

  // url to get departaments
  get_departaments_url = 'http://localhost:8001/api/v1/departments/';
  save_departaments_url = 'http://localhost:8001/api/v1';
  delete_departaments_url = 'http://localhost:8001/api/v1/departments/';

  // url to inquireform
  get_inquireForms_url = 'http://localhost:8001/api/v1/inquirerforms/';
  save_inquireForms_url = 'http://localhost:8001/api/v1';
  delete_inquireForms_url = 'http://localhost:8001/api/v1/inquirerforms/';

  // url to delete BP status
  delete_Status_url = 'http://localhost:8001/api/v1/businessplanstatus/';

  // url to delete business plan statute
  delete_Statutes_url = 'http://localhost:8001/api/v1/businessplanstatutes/';

  // to get all business plan statutos
  get_BusPlanStatutos_url = 'http://localhost:8001/api/v1/businessplanstatutes/';

  // to save any business plan statutos
  Save_BusPlanStatutos_url = 'http://localhost:8001/api/v1';

  // to get all business plan status
  get_BusPlanStatus_url = 'http://localhost:8001/api/v1/businessplanstatus/';

  // to save any business plan status
  Save_BusPlanStatus_url = 'http://localhost:8001/api/v1';

  proponent_PDAC_url = 'http://localhost:8001/api/v1/getkoboforms/';

  // To get all users
  GET_USERS_URL = 'http://localhost:8001/accounts/users/';

  // save user url
  save_user_url = 'http://localhost:8001/accounts';

  // forgot password
  forgot_pass_url = 'http://localhost:8001/accounts';

  // delete user url
  delete_user_url = 'http://localhost:8001/accounts/user/';

  // Auth Token
  getToken_url = 'http://localhost:8001/token/';

  // add valuechains
  base = 'http://localhost:8001/api/v1';

  // to get all value chain
  get_ValueChain_url = 'http://localhost:8001/api/v1/valuechains/'

  // to delete any valueChain
  delete_ValueChain_url = 'http://localhost:8001/api/v1/valuechains/';

  // to create interest expression
  interest_Express_url = 'http://localhost:8001/api/v1';

  // to get value chain by id
  get_ValueChainInExpress_By_Id_url = 'http://localhost:8001/api/v1/valuechaintointerestexpressions/';

  // to get all interest expression
  get_Interest_Exp_url = 'http://localhost:8001/api/v1/interestexpressions/';

  // to get user by id
  get_User_byId_url = 'http://localhost:8001/accounts/user/';

  // to get value chain by id
  get_Cadeia_byId_url = 'http://localhost:8001/api/v1/valuechains/'

  // to get inquirier by id
  get_Iquiridor_byId_url = 'http://localhost:8001/api/v1/inquirers/';

  // to get departament by id
  get_Depart_byId_url = 'http://localhost:8001/api/v1/departments/';

  // to get agreement proposer by id
  get_agreement_proposer_byId_url = 'http://localhost:8001/api/v1/proposeragreements/';

  // to get business plan status by id
  get_Status_byId_url = 'http://localhost:8001/api/v1/businessplanstatus/';

  // to get business plan estatute
  get_Estatute_byId_url = 'http://localhost:8001/api/v1/businessplanstatutes/';

  // to get inquire by id
  get_Iquerito_byId_url = 'http://localhost:8001/api/v1/inquirerforms/';

  // to get all interest expression
  edit_Interest_Exp_url = 'http://localhost:8001/api/v1/interestexpressions/';

  // to update value chain to interest express
  edit_cadeiaManIn_url = 'http://localhost:8001/api/v1/valuechaintointerestexpressions/';

  // to update value chain
  edit__Cadeia_url = 'http://localhost:8001/api/v1/valuechains/';

  // to update data of the inquirier
  edit_inquiridor_url = 'http://localhost:8001/api/v1/inquirers/';

  // to update departaments
  edit_depart_url = 'http://localhost:8001/api/v1/departments/';

  // to update proposer agreement
  edit_acordo_url = 'http://localhost:8001/api/v1/proposeragreements/';

  // to update business plan status
  edit_status_url = 'http://localhost:8001/api/v1/businessplanstatus/';

  // to update business plan statutes
  edit_statutes_url = 'http://localhost:8001/api/v1/businessplanstatutes/';

  // to update data to inquire
  edit_inquerito_url = 'http://localhost:8001/api/v1/inquirerforms/';

  // to edit user
  edit_User_url = 'http://localhost:8001/accounts/user/';

  // to delete any interest espression
  delete_Interest_url = 'http://localhost:8001/api/v1/interestexpressions/';

  // to edit data of interest expression
  edit_Interest_url = 'http://localhost:8001/api/v1/';

  // InterestExpression by province
  interestExpressByProv_url = 'http://localhost:8001/api/v1/interestexpressions/?province=';

  InquiriersByProv_url = 'http://localhost:8001/api/v1/inquirers/?province=';

  proponentsByProv_url = 'http://localhost:8001/api/v1';
  ...
  rebootVM() {
    ...
    return this.http.get('http://localhost:8001/accounts/users/', { headers: headers, params: params })
  }
  ...
  getBasicAreaEchartData(): Observable<BasicEchartLineModel[]> {
    ...
    headers = headers.append('Content-Type', 'application/json');
    headers = headers.append('Authorization', 'Token ' + String(localStorage.getItem('userToken')));
    return this.http.get<BasicEchartLineModel[]>('http://localhost:8001/api/v1/getinterestexpressionsnumberpermonth/', { headers: headers });
  }
